...
public class MyObjectMapperProvider implements ContextResolver<ObjectMapper> {
	...
	public ObjectMapper getContext(final Class<?> type) {
		...
		/*
		 * if (type == Entity.class) { return combinedObjectMapper; } else {
		 */
	...
	/*
	 * private static ObjectMapper createCombinedObjectMapper() { return new
	...
	private static ObjectMapper createDefaultMapper() {
		...
		//result.setPropertyNamingStrategy(new MyPropertyNamingStrategy());
	...
	/*
	 * private static AnnotationIntrospector
	 * createJaxbJacksonAnnotationIntrospector() {
	 * 
	 * final AnnotationIntrospector jaxbIntrospector = new
	 * JaxbAnnotationIntrospector(TypeFactory.defaultInstance()); final
